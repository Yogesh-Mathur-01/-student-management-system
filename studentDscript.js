...
function fetchBranches() {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open('GET', 'fetch_branches.php?department=' + department, true);
    xhr.onload = function() {
        if (xhr.status === 200) {
            console.log("Response from fetch_branches.php: " + xhr.responseText); // Log the response
...
function fetchCourses() {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open('GET', 'fetch_courses.php?department=' + department + '&branch=' + branch, true);
    xhr.onload = function() {
        if (xhr.status === 200) {
            console.log("Response from fetch_courses.php: " + xhr.responseText); // Log the response
